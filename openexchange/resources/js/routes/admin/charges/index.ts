...
*/
export const run = (args: { charge: number | { id: number } } | [charge: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/admin/charges/{charge}/run'
*/
run.url = (args: { charge: number | { id: number } } | [charge: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { charge: args }
    }
...
* @route '/admin/charges/{charge}/run'
*/
run.post = (args: { charge: number | { id: number } } | [charge: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: run.url(args, options),
    method: 'post',
})
