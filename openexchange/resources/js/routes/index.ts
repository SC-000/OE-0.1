...
* @route '/markets'
*/
const marketsForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: markets.url(options),
    method: 'get',
})
...
* @route '/markets'
*/
marketsForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: markets.url(options),
    method: 'get',
})
...
* @route '/markets'
*/
marketsForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: markets.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
* @route '/whitepaper'
*/
const whitepaperForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: whitepaper.url(options),
    method: 'get',
})
...
* @route '/whitepaper'
*/
whitepaperForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: whitepaper.url(options),
    method: 'get',
})
...
* @route '/whitepaper'
*/
whitepaperForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: whitepaper.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
whitepaper.form = whitepaperForm
